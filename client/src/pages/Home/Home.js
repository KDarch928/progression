...
render(){
    return(
        ...
        <Col xs={6} md={4} >
        <Image src="../../images/friends.jpg" responsive className="intro" />
        <h1> Goal Idea </h1>
        ...
        <Col xs={6} md={4}>
        <Image src="../../images/friends.jpg" className="intro" responsive />
        <h1> Plan Goal</h1>
        ...
        <br/>
        <br/>
        <h1> We are here to make you set up your goals easily and more accessible</h1>s
        </Col>
        </Row>
        </Grid>
    )
